...
// return num of pokemon a trainer owns in the team
int num_team_pokemon(info_t *trainer)
{
    int num = 0;
...
void print_bag()
{
    ...
    mvprintw(j + 3, xN / 3 + 3, "- Revives selected Pokemon if it was knocked out.");
    mvprintw(j + 6, xN / 3 + 3, "- Heals selected Pokemon for 20HP.");

    refresh();
}

void print_Stored_Pokemon()
{
    int i, j, index = 0, counter = 1;
    ...
    mvprintw(2, 3, "Pokemon Storage:");

    if (Bworld.storage[index] != NULL)
        for (i = 0; i < int(sizeof(x) / sizeof(x[0])) && Bworld.storage[index] != NULL; i++)
        {
            for (j = 3; j < yN && Bworld.storage[index] != NULL; j += 2)
            {
                mvprintw(j, x[i], "%d. %s \t (Level: %d)", counter++, Bworld.storage[index]->get_pokemon().identifier.data(), Bworld.storage[index]->get_level());
                index++;
            }
        }
    else
        mvprintw(3, 3, "NO STORED POKEMON!");
...
void pokecenter()
{
    ...
    int i = 0, j = 0;
    bool complete_action = false, exit = false;
    ...
    while (!exit)
    {
        ...
        // Let Player Choose between Healing, Access Pokemon Storage, Exit
        mvprintw(22, 0, "                                                                               ");
        mvprintw(23, 0, "                                                                               ");
        mvprintw(22, 0, "Welcome to the PokeCenter! How may I help you today?");
        mvprintw(23, 0, "1. Heal Pokemons     2. Open Storage     3. Exit");
        refresh();
        ...
        // heal
        case '1':
            for (i = 0; i < 6 && Bworld.pc.captured[i] != NULL; i++)
            {
                Bworld.pc.captured[i]->set_currHP(Bworld.pc.captured[i]->get_maxHP());
            }
            ...
            mvprintw(22, 0, "Pokemons in your team have been healed!");
            mvprintw(23, xN - 27, "Press ANY key to continue.");
            getch();
            break;
        ...
        case '2':
            ...
            {
                print_Stored_Pokemon();

                mvprintw(22, 0, "                                                                               ");
                mvprintw(23, 0, "                                                                               ");

                mvprintw(22, 0, "You have entered to the Pokemon Storage! What do you choose to do?");
                mvprintw(23, 0, "1. Deposit Pokemon     2. Add Pokemon     3. Return");
                refresh();
                ...
                case '1':
                    mvprintw(22, 0, "                                                                               ");
                    mvprintw(23, 0, "                                                                               ");
                    // can't deposit if you only own one pokemon in the team
                    if (num_team_pokemon(&Bworld.pc) == 1)
                    {
                        mvprintw(22, 0, "Unable to deposit any pokemon. At least one pokemon must be in your team.");
                        mvprintw(23, xN - 27, "Press ANY key to continue.");
                        getch();
                    }
                    // deposit
                    else
                    {
                        ...
                        while (!check)
                        {
                            ...
                            mvprintw(22, 0, "Which pokemon to deposit?");
                            ...
                            case 6:
                                ...
                                {
                                    mvprintw(22, 0, "%s successfully deposited!", Bworld.pc.captured[i - 1]->get_pokemon().identifier.data());
                                    Bworld.storage[Bworld.storage_index] = Bworld.pc.captured[i - 1];
                                    int num_poke = num_team_pokemon(&Bworld.pc);
                                    Bworld.storage_index++;
                                    for (int temp = i - 1; temp < num_poke && temp + 1 < 6; temp++)
                                    {
                                        Bworld.pc.captured[temp] = Bworld.pc.captured[temp + 1];
                                        Bworld.pc.captured[temp + 1] = NULL;
                                    }
                                    check = true;
                                    mvprintw(23, xN - 27, "Press ANY key to continue.");
                                    print_Stored_Pokemon();
                                ...
                                {
                                    mvprintw(22, 0, "Invalid input! Please try again.");
                                    mvprintw(23, xN - 27, "Press ANY key to continue.");
                                    getch();
                                }
                                break;
                ...
                case '2':
                    mvprintw(22, 0, "                                                                               ");
                    mvprintw(23, 0, "                                                                               ");
                    // can't add pokemon if team is full
                    if (num_team_pokemon(&Bworld.pc) == 6)
                    {
                        mvprintw(22, 0, "Unable to add more pokemon. Team is full.");
                        mvprintw(23, xN - 27, "Press ANY key to continue.");
                        getch();
                    }
                    else if (Bworld.storage_index == 0)
                    {
                        mvprintw(22, 0, "No Pokemons to add from storage.");
                        mvprintw(23, xN - 27, "Press ANY key to continue.");
                        getch();
                        break;
                    }
                    ...
                    else
                    {
                        ...
                        while (!check)
                        {
                            ...
                            mvprintw(22, 0, "Which pokemon to add to team (number): ");
                            refresh();
                            echo();
                            curs_set(1);
                            scanw("%d", &num);
                            ...
                            num -= 1;
                            if (Bworld.storage[num] == NULL || num < 0 || num > 5000)
                            {
                                mvprintw(22, 0, "Invalid input! Please try again!");
                                mvprintw(23, xN - 27, "Press ANY key to continue.");
                                getch();
                            ...
                            {
                                mvprintw(22, 0, "%s successfully added!", Bworld.storage[num]->get_pokemon().identifier.data());
                                Bworld.pc.captured[num_team_pokemon(&Bworld.pc)] = Bworld.storage[num];
                                int num_poke_storage = Bworld.storage_index;
                                Bworld.storage_index--;
                                for (int temp = num; temp < num_poke_storage; temp++)
                                {
                                    Bworld.storage[temp] = Bworld.storage[temp + 1];
                                    Bworld.storage[temp + 1] = NULL;
                                }
                                check = true;
                                mvprintw(23, xN - 27, "Press ANY key to continue.");
                                print_Stored_Pokemon();
        ...
        case '3':
            mvprintw(22, 0, "                                                                               ");
            mvprintw(23, 0, "                                                                               ");
            mvprintw(22, 0, "Thank you for your visit! Please feel free to visit us again!");
            mvprintw(23, xN - 27, "Press ANY key to continue.");
            refresh();
            getch();
            exit = true;
...
void print_mart_items()
{
    ...
    j = 3;
    mvprintw(2, 3, "PokeBucks Owned: $%d", Bworld.pc.pokeBucks);
    mvprintw(j, 3, "1. Pokeball (Own: x%d)", Bworld.pc.item->get_num_pokeball());
    mvprintw(j + 3, 3, "2. Revives (Own: x%d)", Bworld.pc.item->get_num_revive());
    mvprintw(j + 6, 3, "3. Potions (Own: x%d)", Bworld.pc.item->get_num_potions());
...
void pokemart()
{
    clear();
    int j = 0, choice, num;
    const int ITEM_PRICE = 100;
    bool action_complete = false, exit = false, check = false;
    ...
    while (!exit)
    {
        ...
        // Let Player choose between Buying, Selling, Exit
        mvprintw(22, 0, "                                                                               ");
        mvprintw(23, 0, "                                                                               ");
        mvprintw(22, 0, "Welcome to the PokeCenter! How may I help you today?");
        mvprintw(23, 0, "1. Buy     2. Sell     3. Exit");
        refresh();
        ...
        case '1':
            while (!action_complete)
            {
                ...
                mvprintw(22, 0, "                                                                               ");
                mvprintw(23, 0, "                                                                               ");
                mvprintw(22, 0, "What would you like to buy?");
                mvprintw(23, 0, "1. Pokeball     2. Revives     3. Potion     4. Return");
                ...
                else if (choice > 0 && choice < 4)
                {
                    ...
                    {
                        mvprintw(22, xN - 22, "Press '0' to return.");
                        mvprintw(22, 0, "Please state the amount: ");
                        refresh();
                        echo();
                        curs_set(1);
                        scanw("%d", &num);
                        ...
                        else if (Bworld.pc.pokeBucks < num * ITEM_PRICE)
                        {
                            mvprintw(22, 0, "Insufficient fund! Please try a different amount.");
                            mvprintw(23, xN - 27, "Press ANY key to continue.");
                            getch();
                            mvprintw(22, 0, "                                                                               ");
                            mvprintw(23, 0, "                                                                               ");
                        ...
                        {
                            Bworld.pc.pokeBucks -= (num * ITEM_PRICE);
                            std::string itemName;
                            switch (choice)
                            {
                            case 1:
                                Bworld.pc.item->set_num_pokeball(Bworld.pc.item->get_num_pokeball() + num);
                                itemName = "Pokeballs";
                                break;
                            case 2:
                                Bworld.pc.item->set_num_revive(Bworld.pc.item->get_num_revive() + num);
                                itemName = "Revives";
                                break;
                            case 3:
                                Bworld.pc.item->set_num_potions(Bworld.pc.item->get_num_potions() + num);
                                itemName = "Potions";
                                break;
                            default:
                                break;
                            ...
                            check = true;
                            mvprintw(22, 0, "Successfully bought %d %s!", num, itemName.data());
                            mvprintw(23, xN - 27, "Press ANY key to continue.");
                            getch();
                            mvprintw(22, 0, "                                                                               ");
                            mvprintw(23, 0, "                                                                               ");
        ...
        case '2':
            while (!action_complete)
            {
                ...
                mvprintw(22, 0, "                                                                               ");
                mvprintw(23, 0, "                                                                               ");
                mvprintw(22, 0, "What would you like to sell?");
                mvprintw(23, 0, "1. Pokeball     2. Revives     3. Potion     4. Return");
                ...
                else if (choice > 0 && choice < 4)
                {
                    ...
                    while (!check)
                    {
                        ...
                        else if ((choice == 1 && Bworld.pc.item->get_num_pokeball() < num) || (choice == 2 && Bworld.pc.item->get_num_revive() < num) || (choice == 3 && Bworld.pc.item->get_num_potions() < num))
                        {
                            mvprintw(22, 0, "Insufficient items! Please try a different amount.");
                            mvprintw(23, xN - 27, "Press ANY key to continue.");
                            getch();
                            mvprintw(22, 0, "                                                                               ");
                            mvprintw(23, 0, "                                                                               ");
                        ...
                        {
                            Bworld.pc.pokeBucks += (num * ITEM_PRICE / 2);
                            std::string itemName;
                            switch (choice)
                            {
                            case 1:
                            ...
                            check = true;
                            mvprintw(22, 0, "Successfully sold %d %s for %d!", num, itemName.data(), num * ITEM_PRICE / 2);
                            mvprintw(23, xN - 27, "Press ANY key to continue.");
                            getch();
                            mvprintw(22, 0, "                                                                               ");
                            mvprintw(23, 0, "                                                                               ");
        ...
        case '3':
            ...
            mvprintw(22, 0, "                                                                               ");
            mvprintw(23, 0, "                                                                               ");
            mvprintw(22, 0, "Thank you for your visit! See you soon!");
            mvprintw(23, xN - 27, "Press ANY key to continue.");
            getch();
            mvprintw(22, 0, "                                                                               ");
            mvprintw(23, 0, "                                                                               ");
...
{
    int i, j, action, priority, payment = 0;
        ...
        if (priority >= 10)
        {
            if (!battleEnd && p->get_currHP() > 0)
            {
                ...
                if (selected_pokemon->get_currHP() <= 0)
                {
                    ...
                    {
                        payment = 8 * ((rand() % 5) + 1) * num_team_pokemon(&Bworld.pc);
                        Bworld.pc.pokeBucks = (Bworld.pc.pokeBucks - payment > 0) ? Bworld.pc.pokeBucks - payment : 0;
                        mvprintw(22, 0, "Player whited-out! Please heal using potions and revives!");
                        mvprintw(23, 0, "Player paid $%d as the prize money! Current PokeBucks: $%d", payment, Bworld.pc.pokeBucks);
                        mvprintw(23, xN - 27, "Press ANY key to continue.");
                        refresh();
        ...
        else
        {
            ...
            if (priority > rand_selected_move->priority || (priority == rand_selected_move->priority && selected_pokemon->get_speed() >= p->get_speed()))
            {
                ...
                if (p->get_currHP() <= 0)
                {
                    ...
                    double expGain = 1.5 * p->get_pokemon().base_experience * p->get_level()/ 7;
                    int currLevel = selected_pokemon->get_level();
                    selected_pokemon->addExp((int)expGain);

                    mvprintw(23, 0, "%s gained %d exp!", selected_pokemon->get_pokemon().identifier.data(), (int)expGain);
                    mvprintw(23, xN - 27, "Press ANY key to continue.");
                    getch();
                    mvprintw(22, 0, "                                                                               ");
                    mvprintw(23, 0, "                                                                               ");

                    if (currLevel < selected_pokemon->get_level())
                    {
                        mvprintw(23, 0, "%s leveled up!", selected_pokemon->get_pokemon().identifier.data());
                        mvprintw(23, xN - 27, "Press ANY key to continue.");
                        getch();
                    }
                    ...
                    {
                        for (int tmp = 0; tmp < num_team_pokemon(trainer); tmp++)
                            payment += rand() % 100;

                        Bworld.pc.pokeBucks += payment;
                        battleEnd = true;
                        trainer->defeated = true;
                        mvprintw(22, 0, "Trainer ran out of pokemon. They are defeated!");
                        mvprintw(23, 0, "Player earned $%d from the battle! ($%d)", payment, Bworld.pc.pokeBucks);
                        mvprintw(23, xN - 27, "Press ANY key to continue.");
                        refresh();
                        getch();
                    }
            ...
            if (!battleEnd && p->get_currHP() > 0)
            {
                ...
                if (selected_pokemon->get_currHP() <= 0)
                {
                    ...
                    if (is_white_out(&Bworld.pc))
                    {
                        ...
                        Bworld.pc.pokeBucks = (Bworld.pc.pokeBucks - payment > 0) ? Bworld.pc.pokeBucks - payment : 0;
                        mvprintw(22, 0, "Player whited-out! Please heal using potions and revives!");
                        mvprintw(23, 0, "Player paid $%d as the prize money! ($%d)", payment, Bworld.pc.pokeBucks);
                        mvprintw(23, xN - 27, "Press ANY key to continue.");
                        refresh();
                        Bworld.pc.defeated = true;
                        battleEnd = true;
...
{
    int i, j, action, priority, attempts = 0, nVal, fVal;
    bool battleEnd = false, back = false, consumed_turn = false;
    const moves_db *pc_selected_move, *rand_selected_move;
        ...
        case '3':
            while (!back)
            {
                ...
                case '1':
                    ...
                    nVal = rand() % 256;
                    fVal = (int)floor((p->get_maxHP() * 255 * 4.0) / (p->get_currHP() * 12));
                    ...
                    else
                    {
                        ...
                        if (num_team_pokemon(&Bworld.pc) == 6)
                        {
                            Bworld.storage[Bworld.storage_index++] = p;
                            mvprintw(22, 0, "Your team is full. %s is added into the storage.", p->get_pokemon().identifier.data());
                        }
                        else
                        {
                            // int temp = 5;
                            ...
                            Bworld.pc.captured[num_team_pokemon(&Bworld.pc)] = p;
                            mvprintw(22, 0, "%s is added into the team!", p->get_pokemon().identifier.data());
                        }
                        battleEnd = true;
                    }
                    mvprintw(23, xN - 27, "Press ANY key to continue.");
        ...
        if (priority >= 10)
        {
            if (!battleEnd && p->get_currHP() > 0)
            {
                ...
                if (selected_pokemon->get_currHP() <= 0)
                {
                    ...
                    double expGain = 1.0 * p->get_pokemon().base_experience  * p->get_level()/ 7;
                    int currLevel = selected_pokemon->get_level();
                    selected_pokemon->addExp((int)expGain);
    ...
    while (1)
    {
        ...
        case player:
            ...
            do
            {
                ...
                case '>':
                    // enter building
                    if (Bworld.currMap->mp[Bworld.pc.pos[dim_y]][Bworld.pc.pos[dim_x]] == center)
                        pokecenter();
                    else if (Bworld.currMap->mp[Bworld.pc.pos[dim_y]][Bworld.pc.pos[dim_x]] == mart)
                        pokemart();
                    print_map();
                    dir = no_dir;
                    break;
